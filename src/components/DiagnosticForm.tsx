...
import { CheckCircle2, Home, MapPin, FileText, User, Mail, Phone, Thermometer, Zap, Wrench, Euro, Settings } from "lucide-react";
...
export const DiagnosticForm = () => {
  ...
  const handleSubmit = async () => {
    if (!formData.name || !formData.email || !formData.phone || !formData.province) {
      toast({
        title: "Faltan datos",
        description: "Completa nombre, email, teléfono y provincia.",
        variant: "destructive",
      });
      return;
    }
        ...
        <div className="container-width">
          <Card className="max-w-2xl mx-auto text-center card-elevated">
            <CardHeader>
              ...
              <CardDescription>
                Hemos recibido correctamente tu información. En breve recibirás un correo con los siguientes pasos.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button
                onClick={() => {
                  ...
                  setFormData({
                    ...
                    bathrooms: "", occupancy: "", facadeType: "", insulationState: "", roofInsulation: "",
                    windowType: "", thermalBridge: "", glassType: "", heatingSystem: "", coolingSystem: "",
                    hotWaterSystem: "", solarPanels: "", solarPower: "", battery: "", solarThermal: "",
                    heatPump: "", ventilationSystem: "", electricConsumption: "", gasOilConsumption: "",
                    monthlyBill: "", energyCertificate: "", mainInterest: "", plannedWorks: [], budget: "",
      ...
      <div className="container-width">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Diagnóstico Técnico Completo - 100% Gratuito</h2>
            ...
            <CardContent className="space-y-6">
              ...
              {currentStep === 1 && (
                <div className="space-y-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                      <div className="space-y-3">
                        ...
                        <Select value={formData.constructionYear} onValueChange={(value) => updateFormData("constructionYear", value)}>
                          <SelectTrigger><SelectValue placeholder="Selecciona década" /></SelectTrigger>
                          <SelectContent>
                      ...
                      <div className="space-y-3">
                        ...
                        <Input value={formData.surfaceArea} onChange={(e) => updateFormData("surfaceArea", e.target.value)} placeholder="Ej: 120" type="number" />
                      </div>
                    </div>
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                      <div className="space-y-3">
                        ...
                        <Select value={formData.floors} onValueChange={(value) => updateFormData("floors", value)}>
                          <SelectTrigger><SelectValue placeholder="Plantas" /></SelectTrigger>
                          <SelectContent>
                      ...
                      <div className="space-y-3">
                        ...
                        <Select value={formData.rooms} onValueChange={(value) => updateFormData("rooms", value)}>
                          <SelectTrigger><SelectValue placeholder="Habitaciones" /></SelectTrigger>
                          <SelectContent>
                  ...
                  <Button onClick={() => setCurrentStep(2)} disabled={!formData.propertyType || !formData.constructionYear} className="w-full">
                    Continuar
                  </Button>
                </div>
              )}
              ...
              {currentStep === 2 && (
                <div className="space-y-6">
                      ...
                      <div className="space-y-3">
                        ...
                        <RadioGroup value={formData.roofInsulation} onValueChange={(value) => updateFormData("roofInsulation", value)}>
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <Label htmlFor="lana">Lana mineral (roca o vidrio)</Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="aislamiento_ecologico" id="ecologico" />
                            <Label htmlFor="ecologico">Ecológico (corcho, celulosa, fibras madera)</Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="sandwich_metalico" id="sandwich" />
                            <Label htmlFor="sandwich">PUR/PIR en sándwich metálico</Label>
                          </div>
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem value="reflexivos_multicapa" id="reflexivos" />
                            <Label htmlFor="reflexivos">Reflexivos multicapa</Label>
                          </div>
                        </RadioGroup>
                      </div>
                    )}
                  ...
                  <div className="flex gap-3">
                    <Button variant="outline" onClick={() => setCurrentStep(1)} className="flex-1">Atrás</Button>
                    <Button onClick={() => setCurrentStep(3)} disabled={!formData.facadeType || !formData.insulationState} className="flex-1">Continuar</Button>
                  </div>
                </div>
              )}
                  ...
                  <div className="space-y-4">
                    <div className="space-y-3">
                      ...
                      <RadioGroup value={formData.heatingSystem} onValueChange={(value) => updateFormData("heatingSystem", value)}>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="gas_natural" id="gas" /><Label htmlFor="gas">Gas natural</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="gasoil" id="gasoil" /><Label htmlFor="gasoil">Gasoil</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="electrico" id="electrico" /><Label htmlFor="electrico">Eléctrico</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="biomasa" id="biomasa" /><Label htmlFor="biomasa">Biomasa</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="aerotermia" id="aerotermia" /><Label htmlFor="aerotermia">Aerotermia/Geotermia</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="leña" id="leña" /><Label htmlFor="leña">Chimenea de leña</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="butano" id="butano" /><Label htmlFor="butano">Butano</Label></div>
                      </RadioGroup>
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <RadioGroup value={formData.coolingSystem} onValueChange={(value) => updateFormData("coolingSystem", value)}>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="ninguno" id="frio_ninguno" /><Label htmlFor="frio_ninguno">Ninguno</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="aire_individual" id="individual" /><Label htmlFor="individual">Aire individual</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="multisplit" id="multisplit" /><Label htmlFor="multisplit">Multisplit</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="conductos" id="conductos" /><Label htmlFor="conductos">Conductos</Label></div>
                      </RadioGroup>
                    </div>

                    <div className="space-y-3">
                      <Label className="text-base font-medium">Producción de ACS</Label>
                      <RadioGroup value={formData.hotWaterSystem} onValueChange={(value) => updateFormData("hotWaterSystem", value)}>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="caldera_mixta" id="mixta" /><Label htmlFor="mixta">Caldera mixta</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="termo_electrico" id="termo" /><Label htmlFor="termo">Termo eléctrico</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="solar_termico" id="solar_termico" /><Label htmlFor="solar_termico">Solar térmico</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="bomba_calor_acs" id="bomba_acs" /><Label htmlFor="bomba_acs">Bomba de calor</Label></div>
                      </RadioGroup>
                    </div>
                  </div>

                  <div className="flex gap-3">
                    <Button variant="outline" onClick={() => setCurrentStep(2)} className="flex-1">Atrás</Button>
                    <Button onClick={() => setCurrentStep(4)} disabled={!formData.heatingSystem || !formData.coolingSystem || !formData.hotWaterSystem} className="flex-1">Continuar</Button>
                  </div>
                </div>
              )}
                  ...
                  <div className="space-y-4">
                    <div className="space-y-3">
                      ...
                      <RadioGroup value={formData.solarPanels} onValueChange={(value) => updateFormData("solarPanels", value)}>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="si" id="placas_si" /><Label htmlFor="placas_si">Sí</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="no" id="placas_no" /><Label htmlFor="placas_no">No</Label></div>
                      </RadioGroup>
                    </div>
                    ...
                    {formData.solarPanels === "si" && (
                      <>
                        <div className="space-y-3">
                          ...
                          <Input value={formData.solarPower} onChange={(e) => updateFormData("solarPower", e.target.value)} placeholder="Ej: 5.5" type="number" />
                        </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <RadioGroup value={formData.battery} onValueChange={(value) => updateFormData("battery", value)}>
                            <div className="flex items-center space-x-2"><RadioGroupItem value="si" id="bateria_si" /><Label htmlFor="bateria_si">Sí</Label></div>
                            <div className="flex items-center space-x-2"><RadioGroupItem value="no" id="bateria_no" /><Label htmlFor="bateria_no">No</Label></div>
                          </RadioGroup>
                        </div>
                      </>
                    )}
                    ...
                    <div className="space-y-3">
                      ...
                      <RadioGroup value={formData.solarThermal} onValueChange={(value) => updateFormData("solarThermal", value)}>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="si" id="termica_si" /><Label htmlFor="termica_si">Sí</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="no" id="termica_no" /><Label htmlFor="termica_no">No</Label></div>
                      </RadioGroup>
                    </div>

                    <div className="space-y-3">
                      <Label className="text-base font-medium">¿Aerotermia/Geotermia?</Label>
                      <RadioGroup value={formData.heatPump} onValueChange={(value) => updateFormData("heatPump", value)}>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="si" id="bomba_si" /><Label htmlFor="bomba_si">Sí</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="no" id="bomba_no" /><Label htmlFor="bomba_no">No</Label></div>
                      </RadioGroup>
                    </div>

                    <div className="space-y-3">
                      <Label className="text-base font-medium">¿Ventilación mecánica con recuperación de calor?</Label>
                      <RadioGroup value={formData.ventilationSystem} onValueChange={(value) => updateFormData("ventilationSystem", value)}>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="si" id="ventilacion_si" /><Label htmlFor="ventilacion_si">Sí</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="no" id="ventilacion_no" /><Label htmlFor="ventilacion_no">No</Label></div>
                      </RadioGroup>
                    </div>
                  </div>

                  <div className="flex gap-3">
                    <Button variant="outline" onClick={() => setCurrentStep(3)} className="flex-1">Atrás</Button>
                    <Button onClick={() => setCurrentStep(5)} disabled={!formData.solarPanels || !formData.solarThermal || !formData.heatPump || !formData.ventilationSystem} className="flex-1">Continuar</Button>
                  </div>
                </div>
              )}
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="space-y-3">
                      ...
                      <Input value={formData.electricConsumption} onChange={(e) => updateFormData("electricConsumption", e.target.value)} placeholder="Ej: 4500" type="number" />
                    </div>

                    <div className="space-y-3">
                      <Label>Consumo de gas/gasoil anual</Label>
                      <Input value={formData.gasOilConsumption} onChange={(e) => updateFormData("gasOilConsumption", e.target.value)} placeholder="Ej: 2000 litros o 15000 kWh" />
                    </div>

                    <div className="space-y-3">
                      <Label>Factura energética mensual aproximada (€)</Label>
                      <Input value={formData.monthlyBill} onChange={(e) => updateFormData("monthlyBill", e.target.value)} placeholder="Ej: 150" type="number" />
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <Select value={formData.energyCertificate} onValueChange={(value) => updateFormData("energyCertificate", value)}>
                        <SelectTrigger><SelectValue placeholder="Selecciona la clase energética" /></SelectTrigger>
                        <SelectContent>
                  ...
                  <div className="flex gap-3">
                    <Button variant="outline" onClick={() => setCurrentStep(4)} className="flex-1">Atrás</Button>
                    <Button onClick={() => setCurrentStep(6)} disabled={!formData.monthlyBill || !formData.energyCertificate} className="flex-1">Continuar</Button>
                  </div>
                </div>
              )}
                  ...
                  <div className="space-y-4">
                    <div className="space-y-3">
                      ...
                      <RadioGroup value={formData.mainInterest} onValueChange={(value) => updateFormData("mainInterest", value)}>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="ahorro_factura" id="ahorro" /><Label htmlFor="ahorro">Ahorro en factura</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="revalorizacion" id="valor" /><Label htmlFor="valor">Revalorización</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="confort" id="confort" /><Label htmlFor="confort">Confort térmico</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="normativo" id="normativo" /><Label htmlFor="normativo">Cumplimiento normativo</Label></div>
                      </RadioGroup>
                    </div>

                    <div className="space-y-3">
                      <Label className="text-base font-medium">Obras previstas</Label>
                      <div className="space-y-2">
                        {[
                          ...
                          { id: "climatizacion", label: "Cambio de climatización" },
                    ...
                    <div className="space-y-3">
                      ...
                      <RadioGroup value={formData.budget} onValueChange={(value) => updateFormData("budget", value)}>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="menos_10k" id="10k" /><Label htmlFor="10k">Menos de 10.000€</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="10k_30k" id="30k" /><Label htmlFor="30k">10.000€ - 30.000€</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="30k_60k" id="60k" /><Label htmlFor="60k">30.000€ - 60.000€</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="mas_60k" id="mas60k" /><Label htmlFor="mas60k">Más de 60.000€</Label></div>
                      </RadioGroup>
                    </div>
                  </div>

                  <div className="flex gap-3">
                    <Button variant="outline" onClick={() => setCurrentStep(5)} className="flex-1">Atrás</Button>
                    <Button onClick={() => setCurrentStep(7)} disabled={!formData.mainInterest || formData.plannedWorks.length === 0 || !formData.budget} className="flex-1">Continuar</Button>
                  </div>
                </div>
              )}
              ...
              {currentStep === 7 && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="space-y-3">
                      <Label className="text-base font-medium">¿Subvenciones / PREE 5000?</Label>
                      <RadioGroup value={formData.interestSubsidies} onValueChange={(value) => updateFormData("interestSubsidies", value)}>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="si" id="sub_si" /><Label htmlFor="sub_si">Sí</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="no" id="sub_no" /><Label htmlFor="sub_no">No</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="informacion" id="sub_info" /><Label htmlFor="sub_info">Necesito más info</Label></div>
                      </RadioGroup>
                    </div>

                    <div className="space-y-3">
                      <Label className="text-base font-medium">¿Financiación privada (crédito verde, hipoteca eficiente)?</Label>
                      <RadioGroup value={formData.interestFinancing} onValueChange={(value) => updateFormData("interestFinancing", value)}>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="si" id="fin_si" /><Label htmlFor="fin_si">Sí</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="no" id="fin_no" /><Label htmlFor="fin_no">No</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="informacion_fin" id="fin_info" /><Label htmlFor="fin_info">Necesito más info</Label></div>
                      </RadioGroup>
                    </div>

                    <div className="space-y-3">
                      <Label>Municipio</Label>
                      <Input value={formData.city} onChange={(e) => updateFormData("city", e.target.value)} placeholder="Ej: Valladolid" />
                    </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <RadioGroup value={formData.environment} onValueChange={(value) => updateFormData("environment", value)}>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="urbano" id="urbano" /><Label htmlFor="urbano">Urbano</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="periurbano" id="periurbano" /><Label htmlFor="periurbano">Periurbano</Label></div>
                        <div className="flex items-center space-x-2"><RadioGroupItem value="rural" id="rural_env" /><Label htmlFor="rural_env">Rural</Label></div>
                      </RadioGroup>
                    </div>
                  </div>

                  <div className="flex gap-3">
                    <Button variant="outline" onClick={() => setCurrentStep(6)} className="flex-1">Atrás</Button>
                    <Button onClick={() => setCurrentStep(8)} disabled={!formData.interestSubsidies || !formData.interestFinancing || !formData.city || !formData.environment} className="flex-1">Continuar</Button>
                  </div>
                </div>
              )}
              ...
              {currentStep === 8 && (
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <div className="space-y-3">
                      <Label className="flex items-center gap-2 text-base font-medium"><User className="w-4 h-4" />Nombre completo *</Label>
                      <Input value={formData.name} onChange={(e) => updateFormData("name", e.target.value)} placeholder="Tu nombre completo" required />
                    </div>

                    <div className="space-y-3">
                      <Label className="flex items-center gap-2 text-base font-medium"><Mail className="w-4 h-4" />Email *</Label>
                      <Input type="email" value={formData.email} onChange={(e) => updateFormData("email", e.target.value)} placeholder="tu@email.com" required />
                    </div>

                    <div className="space-y-3">
                      <Label className="flex items-center gap-2 text-base font-medium"><Phone className="w-4 h-4" />Teléfono *</Label>
                      <Input type="tel" value={formData.phone} onChange={(e) => updateFormData("phone", e.target.value)} placeholder="600 000 000" required />
                    </div>

                    <div className="space-y-3">
                      <Label className="flex items-center gap-2 text-base font-medium"><MapPin className="w-4 h-4" />Provincia de residencia *</Label>
                    ...
                    <div className="p-4 bg-muted rounded-lg">
                      <p className="text-sm text-muted-foreground">
                        Al completar este formulario, recibirás un informe técnico personalizado y un experto te contactará en las próximas 24h.
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <Button onClick={handleSubmit} disabled={!formData.name || !formData.email || !formData.phone || !formData.province || isSubmitting} className="flex-1">
