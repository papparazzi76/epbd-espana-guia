...
export const ProfilesSection = () => {
  return (
    <HelmetProvider>
      <Helmet>
        <title>Obligaciones EPBD 2024 por Perfil (Propietario, Arrendador)</title>
        <meta 
          name="description" 
          content="Descubre tus obligaciones específicas según la nueva normativa EPBD 2024. Guía para propietarios, arrendadores, compradores y comunidades de vecinos." 
        />
        <link rel="canonical" href="https://guiaepbd2024.es/obligaciones" />
      </Helmet>
