                ...
                <section className="mb-10">
                    ...
                    <div className="grid md:grid-cols-2 gap-6">
                        <div className="bg-blue-100 border-l-4 border-blue-500 p-4 rounded-r-lg">
                            ...
                            <p className="text-blue-700 text-sm">Exige ver el CEE actualizado. Una vivienda Clase G puede quedar **sin poder venderse** a partir de 2033.</p>
                        </div>
                ...
                <section className="mb-10">
                    ...
                    <div className="grid md:grid-cols-3 gap-4">
                        ...
                        <div className="bg-red-100 border-l-4 border-red-500 p-4 rounded-r-lg">
                            ...
                            <p className="text-red-700 text-sm">Prohibido vender viviendas **Clase G**.</p>
                        </div>
                        <div className="bg-red-100 border-l-4 border-red-500 p-4 rounded-r-lg">
                            <p className="font-bold text-red-800 text-xl">2035</p>
                            <p className="text-red-700 text-sm">Prohibido vender viviendas **Clase F**.</p>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">No aceptes uno de hace más de 10 años. Debe reflejar el estado actual de la vivienda.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-4 p-4 bg-gray-50 rounded-lg">
